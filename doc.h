...
*
*	- candidat célibataire -> quand il n'y as q'un seul candidat possible.
*	- candidats célibataire caché -> quand il n'est pas le seul candidat pour une cellule, mais que sa présence est unique dans un groupe.
*   - DIMENSION -> taille de la sous-grille du sudoku
*
...
*	(ex : la première ligne ayant un 1, un 4 et un 9.
